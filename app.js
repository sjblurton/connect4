document.addEventListener("DOMContentLoaded", () => {
  ...
  for (let i = 0, len = squares.length; i < len; i++) {
    ...
    function checkBoard() {
      // an array of all possible winning arrays in connet4
      const winningArrays = [
        [0, 1, 2, 3],
        [41, 40, 39, 38],
        [7, 8, 9, 10],
      ...
      // take the 4 values in each winningArray and plug them into the sqaures
      for (let y = 0; y < winningArrays.length; y++) {
        ...
        //check if the arrays have a class of player-one
    ...
    // eventlistener to each square that will tigger the checkboard
